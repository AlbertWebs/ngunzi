        ...
        <div class="blog-details-page pt-130 mb-130">
            ...
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-10" style="margin:0 auto">
                    ...
                    <?php
                        $ServiceProcessNext = DB::table('blogs')->where('id', '<>',  $blog->id )->limit('1')->orderBy('id','ASC')->get();

                        $ServiceProcessPrev = DB::table('blogs')->where('id', '<>',  $blog->id )->limit('1')->orderBy('id','DESC')->get();
                    ?>
